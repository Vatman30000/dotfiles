...
tagkey = gears.table.join(
	...
	-- заменил, тк это сочетание перехватывает ibus для смены раскладки
	...
	end, { description = "сделать скриншот (flameshot)", group = "custom" }),
	awful.key({ modkey }, "z", function()
		for s in screen do
			s.mywibox.visible = not s.mywibox.visible
		end
	end, { description = "zen mode", group = "custom" }),
